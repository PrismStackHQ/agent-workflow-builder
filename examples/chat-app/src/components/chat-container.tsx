...
export function ChatContainer() {
  const { messages, connected, processing, sendMessage, handleOAuthComplete, confirmPlan, clearMessages, handleNextAction, dismissNextActions } =
    useAgentChat();
  ...
  return (
    <div className="h-screen flex bg-white">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        {/* Messages */}
        <MessageList messages={messages} onOAuthConnect={handleOAuthComplete} onPlanConfirm={confirmPlan} onNextAction={handleNextAction} onDismissNextActions={dismissNextActions} />
